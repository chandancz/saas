...
const INIT_SCHOOLS: School[] = [
  { id: 'SCH001', name: 'Greenfield International School', code: 'GIS-001', type: 'CBSE', city: 'New Delhi', state: 'Delhi', plan: 'Premium', status: 'Active', students: 2840, teachers: 142, joined: 'Jan 10, 2024', email: 'admin@greenfield.edu.in', phone: '+91 98765 43210' },
  { id: 'SCH002', name: 'Sunrise Public School', code: 'SPS-002', type: 'ICSE', city: 'Mumbai', state: 'Maharashtra', plan: 'Standard', status: 'Trial', students: 1200, teachers: 68, joined: 'Mar 22, 2024', email: 'info@sunrisepublic.edu.in', phone: '+91 87654 32109' },
  { id: 'SCH003', name: 'City Montessori School', code: 'CMS-003', type: 'CBSE', city: 'Lucknow', state: 'Uttar Pradesh', plan: 'Enterprise', status: 'Active', students: 6200, teachers: 310, joined: 'Nov 5, 2023', email: 'contact@cms.edu.in', phone: '+91 76543 21098' },
  { id: 'SCH004', name: 'Bright Future Academy', code: 'BFA-004', type: 'State Board', city: 'Chennai', state: 'Tamil Nadu', plan: 'Basic', status: 'Trial', students: 480, teachers: 28, joined: 'Apr 18, 2024', email: 'admin@brightfuture.edu.in', phone: '+91 65432 10987' },
  { id: 'SCH005', name: 'Delhi Public School', code: 'DPS-005', type: 'CBSE', city: 'Bangalore', state: 'Karnataka', plan: 'Premium', status: 'Active', students: 3400, teachers: 175, joined: 'Feb 14, 2024', email: 'dps@bangalore.edu.in', phone: '+91 54321 09876' },
  { id: 'SCH006', name: 'Ryan International School', code: 'RIS-006', type: 'CBSE', city: 'Pune', state: 'Maharashtra', plan: 'Standard', status: 'Expired', students: 1850, teachers: 92, joined: 'Jul 30, 2023', email: 'ryan@pune.edu.in', phone: '+91 43210 98765' },
  { id: 'SCH007', name: 'The Heritage School', code: 'THS-007', type: 'IB', city: 'Kolkata', state: 'West Bengal', plan: 'Enterprise', status: 'Active', students: 2100, teachers: 108, joined: 'Sep 12, 2023', email: 'info@heritageschool.edu.in', phone: '+91 32109 87654' },
  { id: 'SCH008', name: 'Presidium School', code: 'PRE-008', type: 'CBSE', city: 'Gurgaon', state: 'Haryana', plan: 'Premium', status: 'Active', students: 1600, teachers: 84, joined: 'May 7, 2024', email: 'presidium@gurgaon.edu.in', phone: '+91 21098 76543' },
  { id: 'SCH009', name: 'Kendriya Vidyalaya No. 1', code: 'KV-009', type: 'CBSE', city: 'Hyderabad', state: 'Telangana', plan: 'Basic', status: 'Active', students: 900, teachers: 52, joined: 'Aug 19, 2023', email: 'kv1@hyderabad.edu.in', phone: '+91 10987 65432' },
  { id: 'SCH010', name: 'La Martiniere College', code: 'LMC-010', type: 'ICSE', city: 'Lucknow', state: 'Uttar Pradesh', plan: 'Standard', status: 'Suspended', students: 1400, teachers: 76, joined: 'Oct 3, 2023', email: 'lmc@lucknow.edu.in', phone: '+91 09876 54321' },
  { id: 'SCH011', name: "St. Xavier's High School", code: 'SXH-011', type: 'ICSE', city: 'Ahmedabad', state: 'Gujarat', plan: 'Standard', status: 'Active', students: 1750, teachers: 88, joined: 'Dec 1, 2023', email: 'xaviers@ahmedabad.edu.in', phone: '+91 98760 43211' },
  { id: 'SCH012', name: 'Amity International School', code: 'AIS-012', type: 'CBSE', city: 'Noida', state: 'Uttar Pradesh', plan: 'Enterprise', status: 'Active', students: 5200, teachers: 260, joined: 'Jun 15, 2023', email: 'amity@noida.edu.in', phone: '+91 87651 32100' },
];
...
function RegistrationModal({ onClose, onSuccess }: { onClose: () => void; onSuccess: (s: School) => void }) {
  ...
  async function submit() {
    ...
    const code = form.code.trim() || `SCH-${Date.now().toString().slice(-4)}`;
    const school: School = {
      id: `SCH${Date.now()}`, name: form.name, code, type: form.type,
      city: form.city, state: form.state, plan: selectedPlan ?? 'Basic',
      status: 'Trial', students: 0, teachers: 0,
...
export default function SchoolsPage() {
  ...
  const [schools, setSchools]       = useState<School[]>(INIT_SCHOOLS);
                    ...
                    <tr key={school.id}
                      ...
                      <td className="px-3 py-3.5" onClick={e => e.stopPropagation()}>
                        <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          <button title="Delete" className="w-7 h-7 rounded-lg bg-red-50 dark:bg-red-950/40 text-red-500 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/50 flex items-center justify-center transition-colors">
