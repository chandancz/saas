...
export const NAV = [
  ...
  { label: 'Schools',         icon: ICONS.schools,       href: '/schools' },
  { label: 'Users',           icon: ICONS.users,         href: '/users' },
  { label: 'Subscriptions',   icon: ICONS.subscriptions, href: '/subscriptions' },
  { label: 'Payments',        icon: ICONS.payments,      href: '/payments' },
  { label: 'Analytics',       icon: ICONS.analytics,     href: '/analytics' },
  { label: 'Support Tickets', icon: ICONS.support,       href: '/support' },
  { label: 'Audit Logs',      icon: ICONS.audit,         href: '/audit' },
      ...
      <div className="border-t border-slate-100 dark:border-[#2a2d3a] p-3 space-y-1 flex-shrink-0">
        ...
        <div className="flex items-center gap-2.5 px-2 py-2 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 cursor-pointer transition-colors group">
          ...
          <div className={`overflow-hidden transition-all duration-300 flex-1 min-w-0 ${open ? 'opacity-100 max-w-[120px]' : 'opacity-0 max-w-0'}`}>
            <p className="text-xs font-bold text-slate-900 dark:text-white truncate leading-none">Super Admin</p>
            <p className="text-[10px] text-slate-400 dark:text-slate-500 truncate mt-0.5">platform@schools.in</p>
          </div>
        ...
        >
          <span className="w-8 h-8 rounded-xl bg-slate-100 dark:bg-white/10 flex items-center justify-center text-slate-500 dark:text-slate-300 flex-shrink-0 group-hover:bg-slate-200 dark:group-hover:bg-white/15 transition-colors">
